# The JBoss Tools Simulation project
...
_JBoss Tools Simulation_ is part of [JBoss Tools](http://jboss.org/tools) from
...
and then clone your fork:
    ...
    $ git clone git@github.com:<you>/jbosstools-sim.git
    $ cd jbosstools-sim
    $ git remote add upstream git://github.com/jbosstools/jbosstools-sim.git
...
## Building JBoss Tools Simulation

To build _JBoss Tools Simulation_ requires specific versions of Java (1.6+) and
...
_JBoss Tools Simulation_ is open source, and we welcome anybody that wants to
participate and contribute!

If you want to fix a bug or make any changes, please log an issue in
the [JBoss Tools JIRA](https://issues.jboss.org/browse/JBIDE)
describing the bug or new feature and give it a component type of
`BrowserSim` or `CordovaSim`. Then we highly recommend making the changes on a
